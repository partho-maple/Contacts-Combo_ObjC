...
{
    UIView * alertSquare = [[UIView alloc]initWithFrame:CGRectMake(0, 0, 200, 190)]; // Edited here. 150
...
{
    _titleLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 180, 40)]; // Edited here. 30
    ...
    _textLabel = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, 180, 80)]; // Edited here. 50
    _textLabel.center = CGPointMake(alertView.frame.size.width/2, 100); // Edited here. 80
...
- (void) buttonSetupForType:(AlertType)type withCancelButton:(BOOL) hasCancelButton andColor:(UIColor*) color
{
    ...
    if (hasCancelButton) {
        ...
        _defaultButton.center = CGPointMake(alertView.frame.size.width/2, 160); // Edited here. 120
    }
